...
export const metadata: Metadata = {
  title: "The Audit — Proof of Work",
  description:
    "Eleven chapters of evidence. Every claim links to the artifact that produced it: architecture, verified result, and the limitation each system still carries.",
...
export default function Proof() {
  return (
    <main id="main">
      {/* The world the audit is read inside — ThreeUI's Kage temple. First
          in the DOM so every section paints over it; it is fixed, so it
